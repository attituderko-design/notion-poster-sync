...
# ── HARMONIA_CONCERT（HARMONIA演奏会ヘッダ）DB ───────────────
HARMONIA_CONCERT_KEY_KEYS              = ["concert_key", "harmonia_concert_key", "HARMONIA_CONCERT_KEY", "key"]
HARMONIA_CONCERT_CONCERT_REL_KEYS      = ["演奏会", "FK演奏会", "concert"]
HARMONIA_CONCERT_MANAGED_KEYS          = ["管理開始", "managed", "management_started"]
HARMONIA_CONCERT_SONG_INFO_KEYS        = ["楽曲情報確定", "song_info_confirmed", "songs_confirmed"]
HARMONIA_CONCERT_PRACTICE_INFO_KEYS    = ["練習情報確定", "practice_info_confirmed"]
HARMONIA_CONCERT_PRACTICE_DATE_KEYS    = ["練習日確定", "practice_confirmed", "practice_fixed"]
HARMONIA_CONCERT_REQUIRED_INST_KEYS    = ["必要楽器確定", "required_instruments_confirmed"]
HARMONIA_CONCERT_PARTDEF_KEYS          = ["パート定義確定", "part_definition_confirmed", "definition_confirmed"]
HARMONIA_CONCERT_PARTICIPANT_KEYS      = ["奏者情報確定", "participant_confirmed", "cast_confirmed"]
HARMONIA_CONCERT_OWNERSHIP_KEYS        = ["所有楽器確定", "ownership_confirmed", "owned_instruments_confirmed", "own_fixed"]
HARMONIA_CONCERT_ATTENDANCE_KEYS       = ["出欠確定", "attendance_confirmed"]
HARMONIA_CONCERT_PREFERENCE_KEYS       = ["希望入力確定", "preference_confirmed"]
HARMONIA_CONCERT_BRING_KEYS            = ["持参楽器確定", "bring_confirmed", "bring_fixed"]
HARMONIA_CONCERT_PROPOSAL_KEYS         = ["案提示", "proposal_presented", "proposal"]
HARMONIA_CONCERT_ASSIGN_KEYS           = ["アサイン確定", "assign_confirmed", "confirmed"]
HARMONIA_CONCERT_FINANCE_KEYS          = ["収支確定", "finance_confirmed", "budget_confirmed"]
