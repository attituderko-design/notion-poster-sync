...
HARMONIA_CONCERT_KEY_KEYS          = ["concert_key", "ConcertKey", "harmonia_concert_key", "タイトル"]
...
HARMONIA_CONCERT_PRACTICE_DATE_KEYS = ["練習日確定", "practice_dates_confirmed"]
...
HARMONIA_CONCERT_PLAYER_INFO_KEYS  = ["奏者情報確定", "player_info_confirmed"]
HARMONIA_CONCERT_OWN_INST_KEYS     = ["所有楽器確定", "own_instruments_confirmed"]
HARMONIA_CONCERT_ATTENDANCE_KEYS   = ["出欠確定", "attendance_confirmed"]
HARMONIA_CONCERT_PREFERENCE_KEYS   = ["希望入力確定", "preference_confirmed"]
HARMONIA_CONCERT_BRING_KEYS        = ["持参楽器確定", "bring_instruments_confirmed"]
HARMONIA_CONCERT_PLAN_KEYS         = ["案提示", "plan_presented"]
HARMONIA_CONCERT_ASSIGN_KEYS       = ["アサイン確定", "assignment_confirmed"]
